...
@section('title', 'Edit Class - School Management')
                ...
                <div class="grid grid-cols-6 gap-6">
                    <div class="col-span-6 sm:col-span-3">
                        ...
                        <select id="name" name="name" class="mt-1 block w-full py-2 px-3 border border-gray-300 bg-white rounded-md shadow-sm focus:outline-none focus:ring-indigo-500 focus:border-indigo-500 sm:text-sm">
                            <option {{ $schoolClass->name == 'Form 1' ? 'selected' : '' }}>Form 1</option>
                            <option {{ $schoolClass->name == 'Form 2' ? 'selected' : '' }}>Form 2</option>
                            <option {{ $schoolClass->name == 'Form 3' ? 'selected' : '' }}>Form 3</option>
                            <option {{ $schoolClass->name == 'Form 4' ? 'selected' : '' }}>Form 4</option>
                        </select>
                    </div>

                    <div class="col-span-6 sm:col-span-3">
                        <label for="section" class="block text-sm font-medium text-gray-700">Section</label>
                        <input type="text" name="section" id="section" value="{{ $schoolClass->section }}" class="mt-1 focus:ring-indigo-500 focus:border-indigo-500 block w-full shadow-sm sm:text-sm border-gray-300 rounded-md border p-2">
                    </div>
